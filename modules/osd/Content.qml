...
Item {
    ...
    required property int nightTemp
    required property var setNightTemp
    ...
    ColumnLayout {
        ...
        WrappedLoader {
            ...
            FilledSlider {
                anchors.fill: parent
                to: 2.0
                icon: `brightness_${Math.min(7, Math.round(value * 6) + 1)}`
        ...
        WrappedLoader {
            ...
            sourceComponent: Item {
                ...
                Process {
                    id: nightLightProc
                    running: false
                    command: ["hyprctl", "hyprsunset", "temperature", Math.round(root.nightTemp).toString()]
                }
                ...
                FilledSlider {
                    ...
                    from: 0
                    to: 1
                    value: (6500 - root.nightTemp) / 5500
                    onMoved: {
                        root.setNightTemp(Math.round(6500 - value * 5500))
