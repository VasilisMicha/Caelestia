...
Item {
    ...
    readonly property int exclusiveZone: !disabled && (Config.bar.persistent || visibilities.bar) ? contentWidth : (visibilities.bar ? Config.border.thickness : 0)
    ...
    clip: true
    visible: width > 0
    implicitWidth: (fullscreen || (screen.name === "eDP-1" && !visibilities.bar)) ? 0 : Config.border.thickness
