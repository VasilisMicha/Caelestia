...
ColumnLayout {
    ...
    function handleWheel(y: real, angleDelta: point): void {
        ...
        } else if (y < screen.height / 2 && Config.bar.scrollActions.volume && root.isLaptop) {
            // Volume scroll on top half (Laptop only)
            if (angleDelta.y > 0) Audio.incrementVolume();
            else if (angleDelta.y < 0) Audio.decrementVolume();
        } else if (Config.bar.scrollActions.brightness && root.isLaptop) {
            // Brightness scroll on bottom half (Laptop only)
        ...
        DelegateChooser {
            ...
            DelegateChoice {
                ...
                delegate: WrappedLoader {
                    visible: !root.fullscreen && root.isLaptop
